  ...
  function formSubReward() {
    apiCall('/api/sub-agencies/list').then(function (d) {
      ...
      showCascade(
        ...
        '<button type="button" id="qaSubGo" class="w-full py-3 rounded-xl bg-[#1e3a5f] text-white font-semibold">تسجيل</button>'
      );
  ...
  function formCompanyPayout() {
    apiCall('/api/transfer-companies/list').then(function (d) {
      ...
      showCascade(
        ...
        '<button type="button" id="qaCoGo" class="w-full py-3 rounded-xl bg-[#1e3a5f] text-white font-semibold">تنفيذ</button>'
      );
      document.getElementById('qaBack').addEventListener('click', openOutMenu);
  ...
  function formFundReceive() {
    apiCall('/api/funds/list').then(function (d) {
      ...
      showCascade(
        ...
        '<button type="button" id="qaFdGo" class="w-full py-3 rounded-xl bg-[#1e3a5f] text-white font-semibold">تنفيذ</button>'
      );
      document.getElementById('qaBack').addEventListener('click', openOutMenu);
  ...
  function formFxSpread() {
    apiCall('/api/fx-spread/list').then(function (d) {
      ...
      showCascade(
        ...
        '<button type="button" id="qaFxGo" class="w-full py-3 rounded-xl bg-[#1e3a5f] text-white font-semibold">إضافة ربح</button>'
      );
      document.getElementById('qaBack').addEventListener('click', openInMenu);
      function prev() {
